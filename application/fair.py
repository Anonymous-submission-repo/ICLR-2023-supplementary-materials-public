...
#  python fair.py --seed 1 --data german --fairmetric DSP --budget 5 --method CFO --method CFO
#  python fair.py --seed 1 --data german --fairmetric DSP --budget 5 --method CFO --method Lexico
